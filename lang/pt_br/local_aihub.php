...
$string['privacy:metadata:external:deepseek'] = 'Quando uma chave DeepSeek é resolvida, o prompt é enviado à API DeepSeek para gerar texto.';
...
$string['privacy:metadata:logtable:errormessage'] = 'O motivo da falha, quando houve.';
...
$string['privacy:metadata:logtable:success'] = 'Se a tentativa teve sucesso.';
...
$string['privacy:metadata:preference:deepseek_key'] = 'A chave de API DeepSeek pessoal.';
...
$string['report_errormessage'] = 'Motivo';
$string['report_failed'] = 'Falhou';
$string['report_filter_all'] = 'Todas as tentativas';
$string['report_filter_failures'] = 'Somente falhas';
$string['report_filter_successes'] = 'Somente sucessos';
$string['report_intro'] = 'Requisições de geração de IA atendidas pelas chaves de API do site, de todos os usuários. Uma linha por provedor chamado, então uma requisição que caiu para outro provedor aparece mais de uma vez.';
$string['report_nofailures'] = 'Nenhuma tentativa com falha foi registrada.';
$string['report_nosuccesses'] = 'Nenhuma tentativa com sucesso foi registrada.';
$string['report_status'] = 'Situação';
$string['report_succeeded'] = 'Sucesso';
$string['report_systemuser'] = 'Sistema';
$string['report_title'] = 'Relatório de uso de IA do site';
$string['report_unknownuser'] = 'Usuário #{$a}';
$string['report_user'] = 'Usuário';
$string['settings_deepseek_key'] = 'Chave de API DeepSeek';
$string['settings_deepseek_key_desc'] = 'Chave de API de todo o site para o DeepSeek.';
