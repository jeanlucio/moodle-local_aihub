...
$string['privacy:metadata:external:deepseek'] = 'When a DeepSeek key resolves, the prompt is sent to the DeepSeek API to generate text.';
...
$string['privacy:metadata:logtable:errormessage'] = 'Why the attempt failed, when it did.';
...
$string['privacy:metadata:logtable:success'] = 'Whether the attempt succeeded.';
...
$string['privacy:metadata:preference:deepseek_key'] = 'The personal DeepSeek API key.';
...
$string['report_errormessage'] = 'Reason';
$string['report_failed'] = 'Failed';
$string['report_filter_all'] = 'All attempts';
$string['report_filter_failures'] = 'Only failures';
$string['report_filter_successes'] = 'Only successes';
$string['report_intro'] = 'AI generation requests served by the site-wide API keys, across all users. One row per provider called, so a request that fell back to another provider appears more than once.';
$string['report_nofailures'] = 'No failed attempts have been recorded.';
$string['report_nosuccesses'] = 'No successful attempts have been recorded.';
$string['report_status'] = 'Status';
$string['report_succeeded'] = 'Succeeded';
$string['report_systemuser'] = 'System';
$string['report_title'] = 'Site AI usage report';
$string['report_unknownuser'] = 'User #{$a}';
$string['report_user'] = 'User';
$string['settings_deepseek_key'] = 'DeepSeek API key';
$string['settings_deepseek_key_desc'] = 'Site-wide API key for DeepSeek.';
