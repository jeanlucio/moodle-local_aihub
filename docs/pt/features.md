...
* 📊 **Relatório de uso para o admin:** todas as chamadas a provedores atendidas pelas **chaves do site**, de todos os usuários, com filtro de **somente falhas** e download **CSV / Excel** — protegido por `local/aihub:viewusage`.
