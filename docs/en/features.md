...
* 📊 **Administrator usage report:** every provider call served by the **site keys**, across all users, with a **failures-only** filter and **CSV / Excel** download — gated by `local/aihub:viewusage`.
